<?php
class ModelAdminCatalogProduct extends Model
{
	public function addProduct($data)
	{
		$this->db->query("INSERT INTO " . DB_PREFIX . "product SET " .
			...
			"stock_status_id = '" . (int)($data['stock_status_id'] ?? 1) . "', " .
			...
			"weight_class_id = '" . (int)($data['weight_class_id'] ?? 0) . "', " .
			"length = '" . (float)($data['length'] ?? 0) . "', " .
			"width = '" . (float)($data['width'] ?? 0) . "', " .
			"height = '" . (float)($data['height'] ?? 0) . "', " .
			"length_class_id = '" . (int)($data['length_class_id'] ?? 0) . "', " .
