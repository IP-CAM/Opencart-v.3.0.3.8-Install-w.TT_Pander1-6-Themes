...
<meta name="twitter:image" content="'.$data['logo'].'" />';
		...
		$data['telephone'] = $this->config->get('config_telephone');
				...
				// Extendons - Testimonial Plus
				    $this->load->model('extension/module/testimonials/testimonials');
				    $data['TModuleStatus'] = $this->model_extension_module_testimonials_testimonials->getTModuleStatus();
				    $data['text_testimonials'] = $this->language->get('text_testimonials');
				    
				    $data['testi_link'] = $this->url->link('extension/module/testimonials/testimonials');
