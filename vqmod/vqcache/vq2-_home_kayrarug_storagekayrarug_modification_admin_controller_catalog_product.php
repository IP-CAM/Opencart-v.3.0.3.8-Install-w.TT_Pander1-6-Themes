...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			if ((preg_match('/https?:\/\//', $result['image']) || is_file(DIR_IMAGE . $result['image']))) {
...
$data['entry_custom_imgtitle'] = $this->language->get('entry_custom_imgtitle');
		...
		} elseif (!empty($product_info) && (preg_match('/https?:\/\//', $product_info['image']) || is_file(DIR_IMAGE . $product_info['image']))) {
		...
		foreach ($product_images as $product_image) {
			if ((preg_match('/https?:\/\//', $product_image['image']) || is_file(DIR_IMAGE . $product_image['image']))) {
