	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$data['menus'][] = array(
	            ...
	            // Extendons Testimonials Plus
					$testimonial = array();

					if ($this->user->hasPermission('access', 'extension/module/testimonials/testimonials')) {
						$testimonial[] = array(
							'name'     => $this->language->get('text_manage_testimonials'),
							'href'     => $this->url->link('extension/module/testimonials/testimonials', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()	
						);
					}
					...
					if ($this->user->hasPermission('access', 'extension/module/testimonials')) {
						$testimonial[] = array(
							'name'	   => $this->language->get('text_setting_testimonials'),
					...
					if (isset($testimonial)) {
						$data['menus'][] = array(
							'id'       => 'menu-extendons-testimonials',
							'img'	   => 'view/image/extendons.png', 
							'name'	   => $this->language->get('text_extendons_testimonials'),
							'href'     => '',
							'children' => $testimonial
						);
					}
	            // Extendons Testimonials Plus /-END
